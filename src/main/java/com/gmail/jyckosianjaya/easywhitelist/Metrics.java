...
public class Metrics {
   ...
   public JSONObject getPluginData() {
      ...
      while(var6.hasNext()) {
         CustomChart customChart = (CustomChart)var6.next();
      ...
      while(var4.hasNext()) {
         ...
         try {
            ...
            while(var6.hasNext()) {
               ...
               } catch (IllegalAccessException | InvocationTargetException | NullPointerException | NoSuchMethodException var8) {
               }
            }
